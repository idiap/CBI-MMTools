...
public class OpenLightControl implements SciJavaPlugin, MenuPlugin {

    private Studio studio_;
    private OpenLightControlFrame frame_;
    ...
    public void onPluginSelected() {
        if (frame_ == null) {
            frame_ = new OpenLightControlFrame(studio_);
    ...
    public String getCopyright() {
        return "Idiap Research Institute, 2021";
    }
}
