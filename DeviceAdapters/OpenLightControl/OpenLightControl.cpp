...
const char *g_DeviceNameOpenLightControlHub = "OpenLightControl-Hub";
const char *g_DeviceNameTriggerState = "OpenLightControl-TriggerSelect";
const char *g_DeviceNameEnableShutter = "OpenLightControl-Enable";
const char *g_DeviceNameOutputP1 = "OpenLightControl-OutputP1";
const char *g_DeviceNameOutputP2 = "OpenLightControl-OutputP2";
const char *g_DeviceNameOutputO1 = "OpenLightControl-OutputO1";
const char *g_DeviceNameOutputO2 = "OpenLightControl-OutputO2";
...
{
	RegisterDevice(g_DeviceNameOpenLightControlHub, MM::HubDevice, "Control Hub");
...
MODULE_API MM::Device *CreateDevice(const char *deviceName)
{
	...
	if (strcmp(deviceName, g_DeviceNameOpenLightControlHub) == 0)
	{
						   ...
						   selectTrigger_(-1)
{
	...
	SetErrorText(ERR_NO_PORT_SET, "OpenLightControl Hub device is not connected");
...
{
	CDeviceUtils::CopyLimitedString(name, g_DeviceNameOpenLightControlHub);
}
...
{
	// Name
	int ret = CreateProperty(MM::g_Keyword_Name, g_DeviceNameOpenLightControlHub, MM::String, true);
	if (DEVICE_OK != ret)
		return ret;
